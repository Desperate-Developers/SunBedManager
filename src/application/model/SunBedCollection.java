...
public class SunBedCollection {
	...
	private static final String FILE_NAME_AND_LOCATION = System.getProperties().getProperty("user.home") + "/sunlounger2/sunloungers.xml";
	 ...
	 */
	public int getCount() {
		System.out.println("getCount: " + sunBeds.size());
		return sunBeds.size();
	}
	...
	public void readDataFromFile() throws IOException {
		if (XMLDataExchange.readData(FILE_NAME_AND_LOCATION) instanceof List<?>) {
			...
			System.out.println("Read sunbeds size: " + sunBeds.size());
		}
	}
